...
class Ui_PlaygroundMainWindow(object):
    def setupUi(self, PlaygroundMainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/about_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_about.setIcon(icon1)
        self.action_quit = QAction(PlaygroundMainWindow)
        self.action_quit.setObjectName(u"action_quit")
        icon2 = QIcon()
        icon2.addFile(u":/images/cancel_close_delete_cross_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/about_qt_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_about_qt.setIcon(icon3)
        self.action_settings = QAction(PlaygroundMainWindow)
        self.action_settings.setObjectName(u"action_settings")
        icon4 = QIcon()
        icon4.addFile(u":/images/settings_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_settings.setIcon(icon4)
        self.action_messages = QAction(PlaygroundMainWindow)
        self.action_messages.setObjectName(u"action_messages")
        self.action_animation = QAction(PlaygroundMainWindow)
        self.action_animation.setObjectName(u"action_animation")
        icon5 = QIcon()
        icon5.addFile(u":/images/animation_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.action_animation.setIcon(icon5)
        ...
        self.menu_view.addAction(self.action_messages)
        self.menu_view.addAction(self.action_animation)
        self.tool_bar.addAction(self.action_animation)
    ...
    def retranslateUi(self, PlaygroundMainWindow):
        ...
        self.action_settings.setText(QCoreApplication.translate("PlaygroundMainWindow", u"&Settings", None))
        self.action_messages.setText(QCoreApplication.translate("PlaygroundMainWindow", u"Messages", None))
        self.action_animation.setText(QCoreApplication.translate("PlaygroundMainWindow", u"Animation", None))
        ...
        self.menu_view.setTitle(QCoreApplication.translate("PlaygroundMainWindow", u"&View", None))
